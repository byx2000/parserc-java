...
public class Interpreter {
    ...
    private static final Parser<ArithmeticExpression> arithTerm = separateBy(add.or(sub), arithFact)
            .map(Interpreter::buildArithmeticExpr);
    private static final Parser<ArithmeticExpression> arithExpr = separateBy(mul.or(div).or(rem), arithTerm)
            .map(Interpreter::buildArithmeticExpr);
