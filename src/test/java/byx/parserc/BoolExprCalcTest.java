 ...
 */
class BoolExprCalc {
    private static final Parser<?> lp = ch('(').fatal((s, i) -> new MyParseException("'(' expected"));
    private static final Parser<?> rp = ch(')').fatal((s, i) -> new MyParseException("')' expected"));
    ...
    private static final Parser<Boolean> boolExpr = oneOf(trueValue, falseValue, andExpr, orExpr, notExpr)
        .fatal((s, i) -> new MyParseException("expected one of: t, f, &(...), |(...), !(...)"));
    private static final Parser<Boolean> parser = boolExpr.skip(end()
        .fatal((s, i) -> new MyParseException("redundant character at the end of input")));
