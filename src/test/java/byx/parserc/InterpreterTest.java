...
public class InterpreterTest {
    ...
    public void test() {
        ...
        assertEquals(Map.of("s", 5050, "i", 101), Interpreter.interpret("var s = 0 for (var i = 1; i <= 100; i = i + 1) s = s + i"));
        assertEquals(Map.of("s1", 2550, "s2", 2500, "i", 101), Interpreter.interpret("var s1 = 0 var s2 = 0 for (var i = 1; i <= 100; i = i + 1) {if (i % 2 == 0) s1 = s1 + i else s2 = s2 + i}"));
    }
}
